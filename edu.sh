...
wget -q -O /usr/local/bin/edu-ssh https://raw.githubusercontent.com/DhedyKurnia/freesc/main/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/DhedyKurnia/freesc/main/edu-op.py
